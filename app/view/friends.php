...
<div id="all" class="container-fluid">
    <div class="w-50 px-3 py-3 pt-md-4 pb-md-4 mx-auto text-center">
        <h1 class="display-9 font-weight-bold text-center" style="font-family: cursive;">Friends photo</h1>
    </div>
    <div id="photos">
        ...
        <div class="row" style="margin-top: 1%;">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title border-bottom pb-3"><?php echo $d->username ?> <a href="<?php echo URLROOT . 'about/' . $d->image_id?>" class="float-right btn btn-sm btn-primary">About this photo</a></h5>
